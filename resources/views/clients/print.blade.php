...
<body class="bg-gray-100 text-gray-800 font-sans p-4 sm:p-6 md:p-10">
    <div class="max-w-4xl mx-auto bg-white p-6 sm:p-10 rounded shadow-md border border-gray-300">
        ...
        <div class="mb-8 text-center">
            {{-- Optional logo --}}
            {{-- <img src="{{ asset('images/logo.png') }}" alt="{{ $businessName }}" class="mx-auto mb-2 w-20 sm:w-24"> --}}
            ...
            <p class="text-sm text-gray-500 mt-1">Thank you for choosing to grow with us.</p>
        </div>

        {{-- Greeting & Message --}}
        <div class="mb-6 text-justify leading-relaxed text-sm sm:text-base">
            <p>
                Dear <strong class="text-blue-700">{{ $repayment->loan->name }}</strong>,
            </p>
            <p class="mt-3">
                We are pleased to confirm your loan repayment of
                <strong>UGX {{ number_format($repayment->amount) }}</strong>, made on
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
            <div>
                ...
                <p class="text-sm mt-1 text-gray-600">{{ $repayment->loan->name }}</p>
            </div>
